  ...
  $.ajax({
    ...
    .done(function (data) {
      ...
      data.forEach(function (list) {
        ...
        $("#mylists").append("<a class='see-details' href='https://mediamaster.ieti.site/viewDetailed?id=" + list.list_id + "'><h3>" + list.list_name + "</h3><ul class='list' id='" + list.list_id + "'></ul><p class='overlay-text'></p></a>");
